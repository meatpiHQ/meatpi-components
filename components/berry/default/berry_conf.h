 ...
 */
#include <stddef.h>
void *berry_port_malloc(size_t);
void berry_port_free(void *);
void *berry_port_realloc(void *, size_t);
...
#define BE_EXPLICIT_MALLOC              berry_port_malloc
#define BE_EXPLICIT_FREE                berry_port_free
#define BE_EXPLICIT_REALLOC             berry_port_realloc
