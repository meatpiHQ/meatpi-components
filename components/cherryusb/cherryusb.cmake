...
if(CONFIG_CHERRYUSB_HOST)
    ...
    OR CONFIG_CHERRYUSB_HOST_BL616
        ...
        # WiCAN: platform net glue (usbh_net.c/usbh_lwip.c) deliberately
        # NOT compiled — its strong usbh_<class>_run/stop/eth_input
        # symbols create their own netif and would bypass usb_eth_host's
        # glue (see PROVENANCE.md). usb_eth_host owns those hooks.
    endif()
